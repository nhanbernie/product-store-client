...
import { Search, User, Menu, X, Home, Package, Plus, LogOut } from 'lucide-react';
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link 
              ...
              className={`flex items-center space-x-1 px-3 py-2 rounded-lg transition-colors ${
                isActive('/admin/products/add') ? 'bg-emerald-50 text-emerald-600' : 'text-gray-600 hover:text-emerald-600'
              }`}
            >
              <Plus size={18} />
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <Link 
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors ${
                  isActive('/admin') ? 'bg-emerald-50 text-emerald-600' : 'text-gray-600'
                }`}
              ...
              <Link 
                to="/admin/products/add" 
                className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors ${
                  isActive('/admin/products/add') ? 'bg-emerald-50 text-emerald-600' : 'text-gray-600'
                }`}
                onClick={() => setIsMenuOpen(false)}
              >
                <Plus size={18} />
